"""Oracle S0 field analysis — 0x0E CF=1 blocks.

Analizza la distribuzione di S0.A, FLAGS, B, C su tutti i blocchi campionati.
Output: value ranges, distinct values, intra-block frequency → permette di
inferire se A e C sono node-ID locali (piccoli, densi) o globali (grandi, sparsi).

Uso:
  python3 scripts/oracle_0e_s0.py                  # settore 2252227 + 14 campionati
  python3 scripts/oracle_0e_s0.py --sector S [...]
  python3 scripts/oracle_0e_s0.py --dump-arcs       # stampa ogni S0 record grezzo
"""
