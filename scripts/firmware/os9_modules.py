"""
Enumerates OS-9 and OS-9000 modules within a firmware image.

Scans binary images for standard sync bytes (4AFC/4DAD) to identify and extract embedded OS-9 modules.
"""
