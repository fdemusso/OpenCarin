"""
Scans firmware images for the known text decoder character map.

Searches for the specific 42-byte character table to rapidly locate the CF=1 codec routines in any firmware version.
"""
