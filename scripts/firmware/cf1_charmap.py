"""
Extracts the 42-byte text decoder character table from the firmware.

Reads the precise character mappings used by the CF=1 prefix decoder to reconstruct Latin-1 strings.
"""
