"""
Batch decodes CF=1 blocks to report global success rates.

Runs the decoder across thousands of blocks to verify that the implementation works generically and extracts strings cleanly.
"""
