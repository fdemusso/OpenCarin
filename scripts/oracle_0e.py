"""Oracle validation — BLOCK_TYPE 0x0E CF=1 decoder.

Verifica i claim specifici documentati in:
  docs/CARINDB_BLUEPRINT_EN.md  §6.3.1
  docs/carindb/03-road-network.md  §6.3.1

Per ogni claim stampa: PASS / FAIL / WARN + valore misurato.

Uso:
  python3 scripts/oracle_0e.py                    # settore 2252227 + 9 campionati
  python3 scripts/oracle_0e.py --sector S [...]   # settori specifici
  python3 scripts/oracle_0e.py --sample N         # N blocchi 0x0E casuali

NON usa decode_modugno.py — oracle indipendente.
"""
