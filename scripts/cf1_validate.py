"""Valida una decodifica CF=1 con oracoli strutturali forti.

Oracoli, dal piu' debole al piu' forte:
 1. i bit consumati devono stare dentro il blocco su disco e non avanzarne troppi;
 2. ogni puntatore ricostruito deve cadere dentro il blocco;
 3. i record della sezione 14 (indice dei nomi) devono avere offset monotoni;
 4. il blob dei nomi deve contenere testo leggibile — e' l'ultimo pezzo del
    bitstream, quindi se esce testo vero tutto cio' che lo precede e' corretto.

Uso: python3 scripts/cf1_validate.py [settore ...]
"""
