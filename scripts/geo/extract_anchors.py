"""
Extracts label anchors from type 0x16 feature records for geographic calibration.

This script reads 0x16 CF=1 blocks, decodes their records, and exports named point features
to be used as ground-truth geographic anchors.
"""
