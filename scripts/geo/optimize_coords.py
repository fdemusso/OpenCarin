"""
Performs coordinate system calibration and residual verification.

Uses the extracted point anchors and compares them against known WGS84 coordinates to compute
the optimal linear transformation parameters, validating the 2e9/360 constant.
"""
