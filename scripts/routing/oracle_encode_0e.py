"""
Validates the CF=1 encoder for 0x0E blocks.

Runs a round-trip test (decode -> encode -> decode) and verifies that the output remains byte-perfect and structurally equivalent.
"""
