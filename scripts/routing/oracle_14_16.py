"""
Validation oracle for geographic coordinate ranges.

Decodes 0x14, 0x15, and 0x16 blocks and verifies that their reconstructed absolute X/Y coordinates fall within expected European boundaries.
"""
