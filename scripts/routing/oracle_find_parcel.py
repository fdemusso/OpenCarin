"""
Evaluates the parcel spatial index functionality.

Tests geographic point queries against known ground-truth locations across Europe to validate routing lookups.
"""
