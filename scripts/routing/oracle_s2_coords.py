"""
Validates S2 geographic coordinate reconstruction.

Checks that reconstructed absolute coordinates strictly match the delta ranges defined by M_hi and M_lo limits.
"""
